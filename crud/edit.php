...
<?php include ("./layout/meniu.html");?>
  <div class="container-md w-50 p-3">
    ...
    <form method="post" action="http://localhost/cgaplicatie/crud/pust_update.php?idutilizator=<?php echo $row['id'];?>"  enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
